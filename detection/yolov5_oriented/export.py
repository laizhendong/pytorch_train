...
def export_onnx(model, im, file, opset, train, dynamic, simplify, prefix=colorstr('ONNX:')):
    ...
    try:
        ...
        torch.onnx.export(model, im, f, verbose=False, opset_version=opset,
                          ...
                          input_names=['yolov5_oriented'],
                          output_names=['output'],
                          dynamic_axes={'yolov5_oriented': {0: 'batch', 2: 'height', 3: 'width'},  # shape(1,3,640,640)
        ...
        if simplify:
            try:
                ...
                model_onnx, check = onnxsim.simplify(
                    ...
                    input_shapes={'data': list(im.shape)} if dynamic else None)
