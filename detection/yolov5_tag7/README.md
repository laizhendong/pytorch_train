...
# Tips
1. train.py: 训练入口
2. export: 转onnx，注意input/output名字不必要修改，影响后续转tensorrt
3. model/Channel_TF.yaml是基于yolov5s修改后的模型，增加了kqv注意力机制
4. 该版本是yolov5官网的[v7.0](https://github.com/ultralytics/yolov5/tree/v7.0)版本，可以使用[zn-ftp](/share/ai平台算法相关工具/docker镜像/alg/ubuntu20.04_cuda11)训练
=======================================================
