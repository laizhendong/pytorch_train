...
# Shuffle Color during training
_C.INPUT.BBOX_AUG = CN()
_C.INPUT.BBOX_AUG.SHUFFLE_COLOR_PROB = 0.0
_C.INPUT.BBOX_AUG.FLIP_X_PROB = 0.5
_C.INPUT.BBOX_AUG.BLUR_PROB = 0.0
...
_C.MODEL.RESNETS.BACKBONE_OUT_CHANNELS_SHRINK = 1 #reduce FPN output channel wrt BACKBONE_OUT_CHANNELS
